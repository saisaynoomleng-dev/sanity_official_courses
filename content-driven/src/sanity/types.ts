...
// Query: *[_type == 'post'   && defined(slug.current)][0...12]{  _id,  slug,  title,  body,  mainImage,  publishedAt,  "categories": coalesce(    categories[] -> {      _id,      slug,      title    }, []  ),    author->{      name,      image    }   } | order(publishedAt desc)
...
// Variable: POST_QUERY
// Query: *[_type == 'post'  && slug.current == $slug][0]{  _id,  title,  body,  mainImage,  publishedAt,  "categories": coalesce(    categories[] -> {      _id,      title,      slug    }  ),  author->{    name,    image  }  }
...
declare module "@sanity/client" {
  interface SanityQueries {
    "*[_type == 'post'\n   && defined(slug.current)][0...12]{\n  _id,\n  slug,\n  title,\n  body,\n  mainImage,\n  publishedAt,\n  \"categories\": coalesce(\n    categories[] -> {\n      _id,\n      slug,\n      title\n    }, []\n  ),\n    author->{\n      name,\n      image\n    }\n   } | order(publishedAt desc)": POSTS_QUERYResult;
